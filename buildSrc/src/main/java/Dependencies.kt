...
object Versions {
    ...
    object Lifecycle {
        const val main = "2.6.1"
        const val process = "2.4.0"
        const val ext = "2.2.0"
...
object LifecycleLib {
    const val ViewModel = "androidx.lifecycle:lifecycle-viewmodel-ktx:${Versions.Lifecycle.main}"
    const val SavedState = "androidx.lifecycle:lifecycle-viewmodel-savedstate:${Versions.Lifecycle.main}"
    const val Ext = "androidx.lifecycle:lifecycle-extensions:${Versions.Lifecycle.ext}"
}
