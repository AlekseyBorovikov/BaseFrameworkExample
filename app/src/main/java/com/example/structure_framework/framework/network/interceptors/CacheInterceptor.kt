package com.example.structure_framework.framework.network.interceptors

import android.util.LruCache
import com.example.structure_framework.framework.annotations.Cacheable
import com.example.structure_framework.framework.cache.toCacheResponse
import com.example.structure_framework.framework.cache.toResponse
import com.example.structure_framework.framework.data.CacheResponse
import com.example.structure_framework.framework.extension.HOUR_IN_MILLIS
import com.example.structure_framework.framework.extension.MINUTE_IN_MILLIS
import com.example.structure_framework.framework.extension.SECOND_IN_MILLIS
import com.example.structure_framework.framework.extension.dayOfMonth
import com.example.structure_framework.framework.extension.hour
import com.example.structure_framework.framework.extension.minute
import com.example.structure_framework.framework.extension.month
import com.example.structure_framework.framework.extension.second
import com.example.structure_framework.framework.extension.utc
import com.example.structure_framework.framework.extension.utcToCalendar
import com.example.structure_framework.framework.extension.year
 ...
 * @see [com.example.structure_framework.libraries.framework.annotations.Cacheable]
 * */
